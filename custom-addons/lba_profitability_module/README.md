...
AFTER INSTALLATION
1. USER ACCESS MUST BE GRANTED FIRST TO A GROUP:
THE NAME OF THE GROUP IS: "UNRESTRICTED VIEWS AND ACCESS":
THIS GROUP MUST CONTAIN TEAM LEAD, DEPT MANAGER, PMO, PROJECT MANAGERS, PROJECT ADMIN

2. THEN RESPECTIVE MEMBERS TO THE PROJECT ENHANCEMENT GROUPS
THAT IS ALL ... THIS IS DONE TO AVOID THESE MEMBERS BEING TURNED TO ADMINISTRATOR ON THE PROJECT