...
#     #
#     #     # Sync Document Link when edited
...
#     #
#     #     # Sync Handover Note when edited
#     #     if 'sales_handover_note' in vals:
#     #         for order in self:
#     #             if order.project_id and vals.get('sales_handover_note'):
#     #                 existing = order.project_id.description or ""
#     #                 combined = f"{vals['sales_handover_note']}<br/><br/>{existing}" if existing else vals[
#     #                     'sales_handover_note']
#     #
...
#                     orders_to_sync |= order
#
#         # NEW: Perform the sync for all affected orders
