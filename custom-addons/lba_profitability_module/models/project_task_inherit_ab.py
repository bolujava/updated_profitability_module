...
#
#         if 'assigned_employee_ids' in vals and not ctx.get('import_file'):
#             for task in self:
...
#             hr_employee = self.env['hr.employee'].sudo().browse(employee.id)
#
#             if hr_employee.exists() and hr_employee.employee_type:
#                 employee.employee_type = hr_employee.employee_type
#             else:
...
#             hr_employee = self.env['hr.employee'].sudo().browse(employee.id)
#
#             if hr_employee.exists() and hasattr(hr_employee, 'timesheet_cost'):
#                 employee.timesheet_cost = hr_employee.timesheet_cost
#             else:
...
#
#     # before installation uncomment this and comment the one above and vice versa
#     # class HrEmployeePublic(models.Model):
#     #     _inherit = 'hr.employee.public'
#     #
#     #     employee_type = fields.Selection(
